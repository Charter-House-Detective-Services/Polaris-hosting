...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1375: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1381: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1389: () => new AudioContext(),
      _1390: (x0,x1) => x0.createMediaElementSource(x1),
      _1391: x0 => x0.createGain(),
      _1392: x0 => x0.createStereoPanner(),
      _1393: (x0,x1) => x0.connect(x1),
      _1394: x0 => x0.load(),
      ...
      _1404: x0 => ({type: x0}),
      _1405: (x0,x1) => new Blob(x0,x1),
      _1406: (x0,x1) => x0.item(x1),
      _1407: () => new FileReader(),
      _1409: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1416: (x0,x1) => x0.removeChild(x1),
      _1417: x0 => x0.click(),
      _1429: Date.now,
      _1431: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1432: s => {
      ...
      _1433: () => new Error().stack,
      _1434: () => typeof dartUseDateNowForTicks !== "undefined",
      _1435: () => 1000 * performance.now(),
      _1436: () => Date.now(),
      _1437: () => {
      ...
      _1439: () => new WeakMap(),
      _1440: (map, o) => map.get(o),
      _1441: (map, o, v) => map.set(o, v),
      _1442: (exn) => exn.toString(),
      _1443: (exn) => exn.stack,
      _1444: (exn) => {
      ...
      _1609: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1609(f,arguments.length,x0,x1) }),
      _1610: o => {
      ...
      _1636: (o, p) => p in o,
      _1637: (o, p) => o[p],
      _4258: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._4258(f,arguments.length,x0) }),
      _4259: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._4259(f,arguments.length,x0) }),
      _4264: (x0,x1) => new WebSocket(x0,x1),
      _4265: (x0,x1) => x0.send(x1),
      _4266: (x0,x1,x2) => x0.close(x1,x2),
      _4267: (x0,x1) => x0.close(x1),
      _4268: x0 => x0.close(),
      _4274: () => new AbortController(),
      _4275: x0 => x0.abort(),
      _4276: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _4277: (x0,x1) => globalThis.fetch(x0,x1),
      _4278: (x0,x1) => x0.get(x1),
      _4279: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._4279(f,arguments.length,x0,x1,x2) }),
      _4280: (x0,x1) => x0.forEach(x1),
      _4281: x0 => x0.getReader(),
      _4282: x0 => x0.cancel(),
      _4283: x0 => x0.read(),
      _4302: (x0,x1) => x0.key(x1),
      _4306: o => o instanceof Array,
      _4307: (a, i) => a.push(i),
      _4310: (a, l) => a.length = l,
      _4311: a => a.pop(),
      _4312: (a, i) => a.splice(i, 1),
      _4313: (a, s) => a.join(s),
      _4314: (a, s, e) => a.slice(s, e),
      _4316: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _4317: a => a.length,
      _4318: (a, l) => a.length = l,
      _4319: (a, i) => a[i],
      _4320: (a, i, v) => a[i] = v,
      _4321: (a, t) => a.concat(t),
      _4322: o => {
      ...
      _4323: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _4325: o => o instanceof Uint8Array,
      _4326: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _4327: o => o instanceof Int8Array,
      _4328: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _4329: o => o instanceof Uint8ClampedArray,
      _4330: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _4331: o => o instanceof Uint16Array,
      _4332: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _4333: o => o instanceof Int16Array,
      _4334: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _4335: o => o instanceof Uint32Array,
      _4336: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _4337: o => o instanceof Int32Array,
      _4338: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _4340: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _4341: o => o instanceof Float32Array,
      _4342: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _4343: o => o instanceof Float64Array,
      _4344: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _4345: (t, s) => t.set(s),
      _4346: l => new DataView(new ArrayBuffer(l)),
      _4347: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _4349: o => o.buffer,
      _4350: o => o.byteOffset,
      _4351: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _4352: (b, o) => new DataView(b, o),
      _4353: (b, o, l) => new DataView(b, o, l),
      _4354: Function.prototype.call.bind(DataView.prototype.getUint8),
      _4355: Function.prototype.call.bind(DataView.prototype.setUint8),
      _4356: Function.prototype.call.bind(DataView.prototype.getInt8),
      _4357: Function.prototype.call.bind(DataView.prototype.setInt8),
      _4358: Function.prototype.call.bind(DataView.prototype.getUint16),
      _4359: Function.prototype.call.bind(DataView.prototype.setUint16),
      _4360: Function.prototype.call.bind(DataView.prototype.getInt16),
      _4361: Function.prototype.call.bind(DataView.prototype.setInt16),
      _4362: Function.prototype.call.bind(DataView.prototype.getUint32),
      _4363: Function.prototype.call.bind(DataView.prototype.setUint32),
      _4364: Function.prototype.call.bind(DataView.prototype.getInt32),
      _4365: Function.prototype.call.bind(DataView.prototype.setInt32),
      _4368: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _4369: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _4370: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _4371: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _4372: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _4373: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _4374: Function.prototype.call.bind(Number.prototype.toString),
      _4375: Function.prototype.call.bind(BigInt.prototype.toString),
      _4376: Function.prototype.call.bind(Number.prototype.toString),
      _4377: (d, digits) => d.toFixed(digits),
      _4632: (x0,x1) => { x0.draggable = x1 },
      _4648: x0 => x0.style,
      _5007: (x0,x1) => { x0.download = x1 },
      _5032: (x0,x1) => { x0.href = x1 },
      _5251: x0 => x0.error,
      _5253: (x0,x1) => { x0.src = x1 },
      _5258: (x0,x1) => { x0.crossOrigin = x1 },
      _5261: (x0,x1) => { x0.preload = x1 },
      _5265: x0 => x0.currentTime,
      _5266: (x0,x1) => { x0.currentTime = x1 },
      _5267: x0 => x0.duration,
      _5272: (x0,x1) => { x0.playbackRate = x1 },
      _5281: (x0,x1) => { x0.loop = x1 },
      _5302: x0 => x0.code,
      _5303: x0 => x0.message,
      _5574: (x0,x1) => { x0.accept = x1 },
      _5588: x0 => x0.files,
      _5614: (x0,x1) => { x0.multiple = x1 },
      _5632: (x0,x1) => { x0.type = x1 },
      _6351: () => globalThis.window,
      _6412: x0 => x0.navigator,
      _6676: x0 => x0.localStorage,
      _6800: x0 => x0.userAgent,
      _6851: x0 => x0.data,
      _7008: x0 => x0.length,
      _7225: x0 => x0.readyState,
      _7234: x0 => x0.protocol,
      _7238: (x0,x1) => { x0.binaryType = x1 },
      _7241: x0 => x0.code,
      _7242: x0 => x0.reason,
      _8392: x0 => x0.destination,
      _8396: x0 => x0.state,
      _8487: (x0,x1) => { x0.value = x1 },
      _8636: x0 => x0.gain,
      _8945: x0 => x0.signal,
      _9006: x0 => x0.firstChild,
      _9017: () => globalThis.document,
      _9099: x0 => x0.body,
      _9432: (x0,x1) => { x0.id = x1 },
      _9459: x0 => x0.children,
      _10778: x0 => x0.value,
      _10780: x0 => x0.done,
      _10960: x0 => x0.size,
      _10961: x0 => x0.type,
      ...
      _11473: x0 => x0.url,
      _11475: x0 => x0.status,
      _11477: x0 => x0.statusText,
      _11478: x0 => x0.headers,
      _11479: x0 => x0.body,
      _13885: (x0,x1) => { x0.display = x1 },
      _15107: x0 => x0.name,
